...
namespace Example5
{
    ...
    {   
        ...
        private static void Main(string[] args)
        {
            ...
            string consigna ="Equivalencia de Centimetros con Pies y Pulgadas.";
            double _centimetros;                           // 1 cm es equivalente a 1 centimetro
            

            //genericos
            string _cms = ",tomando como referencia lo ingresado.";

            #region interaccion con el usuario

            Console.WriteLine(consigna);

            Console.Write("\nIngresa el/los centimetros para convertirlos en Pies y Pulgadas :");
            _centimetros = Convert.ToDouble(Console.Read());
            
            //logica de ejecucion
            double _pies = _centimetros * 0.0328084;       // 1 cm es equivalente a 0,0328084 pies
            double _pulgadas = _centimetros * 0.393701;    // 1 cm es equivalente a 0,393701 pulgadas.
